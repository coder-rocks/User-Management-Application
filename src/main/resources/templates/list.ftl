				...
				<form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
					...
					<div class="row">
						<div class="form-group col-md-12">
							...
							<div class="col-md-7">
								<input type="text" ng-model="ctrl.user.age" id="age" class="form-control input-sm" placeholder="Enter your Age." required ng-patterns="ctrl.onlyIntegers"/>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group col-md-12">
							<label class="form-md-2 control-label" for="salary">Salary</label>
							<div class="col-md-7">
